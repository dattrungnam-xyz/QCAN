...
<div class="container">
    ...
    <section class="main">
        ...
        <div   class="edit-profile__container post__status--form"
        >
            <h1 style="font-family:sans-serif; text-transform: uppercase; font-size: 20px; font-weight: bold">Delete Post</h1>
            ...
            <div>
                <form  method="post"  action="PostController?Action=Delete&IdPost=<%=post.getIdPost()%>">


                <button class="edit-profile__button" style="color:white!important;background: red;">Delete</button>
                </form>
            </div>
        </div>
    </section>
